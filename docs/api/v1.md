...
### `POST /debug/:debugID/types/:function`
...
```
{
    address: integer; // unique address of a Variable within the Function
    spiceType: "none" | "string" | "array";
    data: null | { // defined if spiceType = "array"
