...
```
{
    ...
    contents: {object[]}:
        ...
        If type="directory", an array of Files inside the directory. Directories have "contents" field set to undefined.
}
```
...
```
{
  ...
  type {SourceType}: Type of the variable as it is defined in the source code.
